...
const SingleWindow = ({
  ...
  return (
    <div className="pointer-events-auto relative flex h-[50vw] w-full flex-col items-center justify-center sm:h-[40vw] sm:w-2/3 md:h-[35vw] xl:h-[25vw] xl:w-1/2 2xl:h-[25vw] 2xl:w-2/5">
